...
class __Mustache_425ab241fba93bf7cd48123df8526b45 extends Mustache_Template
{
...
';
        ...
        $buffer .= $this->section8e820a766c87e2c07a8ba456d66897a6($context, $indent, $value);
        $value = $context->findDot('state.hasdiscussions');
        if (empty($value)) {
...
';
    ...
    private function section8e820a766c87e2c07a8ba456d66897a6(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
